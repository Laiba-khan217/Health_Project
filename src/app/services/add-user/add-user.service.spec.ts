...
describe('AddUserService', () => {
  ...
  it('should add a new user', () => {
    ...
    service.addUser('Samantha Leo', 'Running', 30);
  ...
  it('should add a new workout to an existing user', () => {
    ...
    service.addUser('Samantha Leo', 'Swimming', 45);
  ...
  it('should update an existing workout for an existing user', () => {
    ...
    service.addUser('Samantha Leo', 'Running', 20);
  ...
  it('should not add a user if workoutMinutes is null', () => {
    ...
    const result = service.addUser('Samantha Leo', 'Running', null);
  ...
  it('should handle invalid localStorage data gracefully', () => {
    ...
    const result = service.addUser('Samantha Leo', 'Running', 30);
  ...
  it('should handle adding a workout to a non-existing user', () => {
    ...
    service.addUser('Harry Thomson', 'Cycling', 60);
  ...
  it('should add a new workout to an existing user with multiple workouts', () => {
    ...
    service.addUser('Samantha Leo', 'Cycling', 60);
  ...
  it('should handle empty localStorage gracefully', () => {
    ...
    service.addUser('Harry Thomson', 'Running', 30);
  ...
  it('should not add a user with empty string values', () => {
    ...
    result = service.addUser('Harry Thomson', null, 30);
    expect(result).toBeFalse();

    result = service.addUser('Harry Thomson', 'Running', null);
    expect(result).toBeFalse();
